        ...
        <>
            ...
            <R.GlobalContainer>
                ...
                <R.ContainerForm>
                    ...
                    <R.Input type='text' placeholder='Document Number - CPF' onChange = {(event) => {setClienteCPF(event.target.value)}}></R.Input>
                    ...
                    <R.Input type='password' placeholder='Password' onChange = {(event) => {setClientePassword(event.target.value)}}></R.Input>
